...
#define BS_IOPINS0_8_VAL ((const uint8 CYFAR *)0x48000320u)
...
#define BS_IOPINS0_2_VAL ((const uint8 CYFAR *)0x48000330u)
...
uint8 CYXDATA * const CYCODE CapSense_AMuxCH0__addrTable[6] = {
...
/* This is an implementation detail of the AMux. Code that depends on it may be
   incompatible with other versions of PSoC Creator. */
const uint8 CYCODE CapSense_AMuxCH0__maskTable[6] = {
	0x40u, 
	0x10u, 
	0x04u, 
	0x10u, 
